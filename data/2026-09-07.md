...
### [6] [Reproducible capillary fluctuation analysis of solid-liquid interfaces for stiffness and anisotropy calculations](https://arxiv.org/abs/2609.04291)
...
### [7] [Accelerating Atom Simulations with Variable-Block Sparse Matrix Library](https://arxiv.org/abs/2609.04397)
...
### [8] [Triboelectrification of a dense metal-organic framework for resilient mechanical energy harvesters](https://arxiv.org/abs/2609.04514)
...
### [9] [Calculation of DFT Spin-Orbit Spillage with Quantum ESPRESSO](https://arxiv.org/abs/2609.04517)
...
### [10] [Structural tuning of reduced exciton mass in layered HOIP compounds: Causation vs. correlation](https://arxiv.org/abs/2609.04558)
...
### [11] [Metallic Organometallic and Semiconducting Covalent Phases of Free-Standing $γ$-Graphdiyne Molecular Wires](https://arxiv.org/abs/2609.04581)
...
### [12] [Initialization-free ultralow-power programmable spin-orbit torque logic devices enabled by chirally asymmetric switching](https://arxiv.org/abs/2609.04594)
...
### [13] [Demonstration of room-temperature, magnetic-field-free, and ultralow-power spin-orbit torque logic device based on composition-uniform van der Waals magnet Fe3GaTe2](https://arxiv.org/abs/2609.04600)
...
### [15] [Hydrogen Storage on Transition-Metal-Decorated Nitrogen-Modified Carbon Nanoribbons](https://arxiv.org/abs/2609.04623)
...
### [16] [4 MV/cm (010) $β$-Ga$_2$O$_3$ Heterojunction Diodes Realized by Low-Damage e-Beam NiO$_x$ Interlayers](https://arxiv.org/abs/2609.04655)
...
### [17] [Field-Driven Coupled Magnon--Phonon--Electron Relaxation in Magnetite Using Steepest-Entropy-Ascent Quantum Thermodynamic Formalism](https://arxiv.org/abs/2609.04798)
...
### [18] [Challenges in orbital current-driven domain wall motion in light metal/ferrimagnet heterostructures](https://arxiv.org/abs/2609.04811)
...
### [19] [Multi-task deep-learning optimization of trade-off properties for superior-performance Fe-based soft magnetic alloys](https://arxiv.org/abs/2609.04845)
...
### [21] [Local coordination, structural softening, and polarization-switching energetics in Sc-alloyed GaN](https://arxiv.org/abs/2609.05000)
...
### [22] [Influence of dislocation density on the tribological response in oxides: case study on SrTiO3](https://arxiv.org/abs/2609.05056)
...
### [23] [Generalized Helicity-Dependent Magnetization Switching via Substrate Phonons](https://arxiv.org/abs/2609.05064)
...
### [24] [A locally ab initio computational framework for arbitrary incommensurate materials interfaces](https://arxiv.org/abs/2609.05082)
...
### [25] [Cross-Layer Anomalous Hall Transport driven by Néel-Vector rotating in the Altermagnet candidate V2Te2O](https://arxiv.org/abs/2609.05085)
...
### [26] [Symmetry-protected triplet Weyl complexes](https://arxiv.org/abs/2609.05120)
...
### [28] [Semiclassical thermoelectric transport in disordered Dirac electron system Ag2Te](https://arxiv.org/abs/2609.05130)
...
### [29] [Interfacial Accommodation as a Candidate Ductility Pathway in Intermetallic-Rich Alloys](https://arxiv.org/abs/2609.05147)
*Avik Mahata*
...
### [30] [Neural-field design of broadband Rayleigh-wave carpet cloaks under microstructure realisability constraints](https://arxiv.org/abs/2609.05163)
...
### [31] [Remote epitaxy beyond polarity](https://arxiv.org/abs/2609.05365)
...
### [32] [Customized spin spirals in ferromagnetic thin films](https://arxiv.org/abs/2609.05383)
...
### [33] [From Electronic Structure to Environmental Remediation: Adsorption of Ionized Glyphosate on COOH-Modified Carbon Nanotube](https://arxiv.org/abs/2609.05392)
...
### [34] [The influence of quantum geometry on the phase boundary and collective excitations of electron liquids and crystals](https://arxiv.org/abs/2609.04330)
...
### [35] [Quantum oscillations of helical edge states of periodically deformed 2D topological insulator in magnetic field](https://arxiv.org/abs/2609.04359)
...
### [36] [Evidence of Crystal-Field-Mediated Anisotropic Orbital Rashba Effect in Epitaxial Ru/FM Heterostructure](https://arxiv.org/abs/2609.04642)
...
### [37] [Interlayer Exciton Condensate Stiffness Is Non-Monotonic in Quantum Metric](https://arxiv.org/abs/2609.04729)
...
### [38] [Excitation caging in a vertex-frustrated quasiperiodic Einstein artificial spin ice](https://arxiv.org/abs/2609.04854)
...
### [39] [Spin-Point-Group Classification of Multipoles for Nonrelativistic Collinear Magnets](https://arxiv.org/abs/2609.04883)
...
### [40] [Cascade spin dynamics of excitons localized in indirect-band-gap (In,Al)As/AlAs quantum dots with type-I band alignment](https://arxiv.org/abs/2609.04951)
...
### [41] [Nonreciprocal plasmonic response of drift-biased two-dimensional metals](https://arxiv.org/abs/2609.04954)
...
### [42] [Bias-field control of the Neel skyrmion nonlinearity in a confined nanostructure](https://arxiv.org/abs/2609.04972)
...
### [43] [ANT:UI: An interactive 3D tool for preparing ANT.Gaussian molecular junction geometries](https://arxiv.org/abs/2609.05030)
...
### [44] [Engineering Giant Thermoelectric Performance through Electrode-Coupling Geometry and Magnetic Flux in Quasiperiodic Su-Schrieffer-Heeger Rings](https://arxiv.org/abs/2609.05078)
...
### [45] [Electrostatic splitting of an Edge Magnetoplasmon Resonator](https://arxiv.org/abs/2609.05188)
...
### [46] [Robustness of RKKY interactions across a Weyl node-annihilation transition](https://arxiv.org/abs/2609.05219)
...
### [47] [Variable Charge State, Magnetic Excitations, and Kondo Effect of Sm/g/Ir(111)](https://arxiv.org/abs/2609.05394)
