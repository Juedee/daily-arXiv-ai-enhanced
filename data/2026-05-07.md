...
### [10] [Meta-LegNet: A Transferable and Interpretable Framework for Surface Adsorption Prediction via Self-Defined Adsorption-Environment Learning](https://arxiv.org/abs/2605.04102)
...
### [11] [An extended ab initio theory of the V$_{\text{B}}^-$ center in hBN: excited states, Jahn-Teller distortion, and pressure dependence](https://arxiv.org/abs/2605.04283)
...
### [12] [Spin Dynamics from Atomistic Quantum Simulations](https://arxiv.org/abs/2605.04294)
...
### [13] [Hydrogen-induced volume expansion in hexagonal close-packed iron: Effects of pressure and temperature](https://arxiv.org/abs/2605.04315)
...
### [14] [Magnetic influence on ion transport in concentrated solid solutions: An analytic investigation](https://arxiv.org/abs/2605.04370)
...
### [15] [Thermodynamics of stacking faults and phase stability in cobalt alloys: A combined computational and experimental study](https://arxiv.org/abs/2605.04420)
...
### [16] [Unveiling the Atomistic Mechanisms of Shear-Induced LDA$\leftrightarrow$HDA Transformations and Shear Banding in Amorphous Silicon under High Pressures](https://arxiv.org/abs/2605.04521)
...
### [17] [Dielectric, magnetic, and magnetodielectric behaviors of BaFe12O19 hexaferrite modulated by Mn and Ti substitutions](https://arxiv.org/abs/2605.04620)
...
### [18] [Effective long-range attraction of moiré excitons under the influence of atomic reconstructions and anisotropic screening](https://arxiv.org/abs/2605.04667)
...
### [19] [Plastic deformation of B19' martensite where -- where it matters in NiTi technology](https://arxiv.org/abs/2605.04669)
...
### [20] [Efficient Quasi-Resonant, Polarization-Selective Excitation of GaN Quantum Emitters](https://arxiv.org/abs/2605.04927)
...
### [21] [Dynamical pseudopotentials](https://arxiv.org/abs/2605.04673)
...
### [22] [A Two-Step Chemical Vapor Deposition Process for the Synthesis of an Ir(111)/Borophene/2D-Hexagonal Boron Nitride Heterostructure by Intrinsic Segregation](https://arxiv.org/abs/2605.04871)
...
### [23] [From Defects to Devices: Design Guidelines for High-Performance Diamond-Based Solar Cells and Single-Dopant Diodes](https://arxiv.org/abs/2605.04942)
...
### [24] [Temperature dependence of the Gibbs energies of formation of point defects in B2 MoTa from ab initio calculations](https://arxiv.org/abs/2605.04969)
...
### [25] [Uncovering hidden bias in neutron diffraction residual strain measurements](https://arxiv.org/abs/2605.05006)
...
### [26] [Building informative materials datasets beyond targeted objectives](https://arxiv.org/abs/2605.05104)
...
### [27] [Regulating oxygen content and superconductivity in La$_3$Ni$_2$O$_{7+δ}$](https://arxiv.org/abs/2605.04562)
...
### [28] [Superconductivity in moiré transition metal dichalcogenide bilayers: comparison of two distinct theoretical approaches](https://arxiv.org/abs/2605.04693)
...
### [29] [Nonlocal transport phenomena in coupled quasiperiodic Kitaev chains](https://arxiv.org/abs/2605.04710)
*Koki Mizuno*
...
### [30] [Response tensor for the superconducting (Josephson) diode effect](https://arxiv.org/abs/2605.04928)
