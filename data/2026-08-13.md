...
### [7] [Soft-Phonon-Driven Effective Inversion-Symmetry Crossover in Quantum Paraelectrics](https://arxiv.org/abs/2608.11471)
...
### [8] [Advances and opportunities for automated robotic preparation of 2D materials and fabrication of 2D heterostructures](https://arxiv.org/abs/2608.11485)
...
### [9] [Magnetoelastic coupling descriptor for high-throughput ab initio search of magnetocaloric materials](https://arxiv.org/abs/2608.11589)
...
### [10] [First-principles cumulant approach to the vibronic structure of spin defects](https://arxiv.org/abs/2608.11687)
...
### [11] [Deep-Learning-Accelerated Dopant Selection for High-k HfO2 Dielectrics: A Disorder-Resolved Study of Y, Si and Al](https://arxiv.org/abs/2608.11725)
...
### [12] [Advancing in situ hydrogen embrittlement studies through an integrated charging cell for SEM micromechanical testing](https://arxiv.org/abs/2608.11773)
...
### [13] [Lithography-free patterning of SrTiO$_3$-based two-dimensional electron gases using direct atomic layer processing](https://arxiv.org/abs/2608.11809)
...
### [14] [Data-Efficient Adaptation of DPA-4 Force Fields to DFT+U Energetics: A Case Study in NiO](https://arxiv.org/abs/2608.11812)
...
### [20] [Beam Routing through Excitons in Transition Metal Dichalcogenide Monolayers](https://arxiv.org/abs/2608.12105)
...
### [21] [Energy-Dependent Dechanneling in Cu: Insights from Monte Carlo Channeling Simulations](https://arxiv.org/abs/2608.12017)
...
### [22] [The electrical transport of intrinsic two-dimensional ferroelectric metal PtBi2](https://arxiv.org/abs/2608.12152)
...
### [23] [Thermoelastic Harvesting Outperforming Thermoelectric Generators Below 100 °C](https://arxiv.org/abs/2608.12092)
...
### [25] [Large bias-tunable magnetoresistance from spin-dependent interlayer hybridization in van der Waals antiferromagnet CrSBr-based heterostructures](https://arxiv.org/abs/2608.11389)
...
### [26] [Layer-Number-Controlled Symmetry Breaking and Surface-State Transport in Rhombohedral Graphene Multilayers](https://arxiv.org/abs/2608.11450)
...
### [27] [Dynamics of the spontaneous emission factor in multiple quantum well nanowire lasers](https://arxiv.org/abs/2608.11523)
...
### [28] [Spatially Resolving the Pre-Thermal Anatomy of a Driven Bosonic Fluid](https://arxiv.org/abs/2608.11561)
...
### [29] [Realization of Arbitrary Gauge Fields via Symmetry-Protected Zero Modes](https://arxiv.org/abs/2608.11609)
...
### [30] [Spin lifetime anisotropy in graphene induced by the SiO2 interface](https://arxiv.org/abs/2608.11615)
...
### [31] [Magnetic noise of a dark exciton Bose-Einstein condensate](https://arxiv.org/abs/2608.11740)
*Pieter M. Gunnink*
...
### [32] [Quantum Anomalous Hall Effect in $d^{10}$ Oxide Monolayers](https://arxiv.org/abs/2608.11855)
...
### [33] [Dimensional crossover and local strain induced deflection of the spin spiral state in multiferroic NiI2](https://arxiv.org/abs/2608.11944)
...
### [34] [Mismatch between Raman shear modes and ferroelectric polarization in 3R-MoS$_{2}$](https://arxiv.org/abs/2608.11988)
...
### [35] [Lectures on ultrathin film ferromagnetism](https://arxiv.org/abs/2608.12189)
*D. Pescia*
...
### [36] [Electron transport in a 1.6~nm-thick double-gated (100) silicon nanosheet: A theoretical study accounting for phonon confinement and remote-phonon scattering](https://arxiv.org/abs/2608.12214)
...
### [37] [Second-Chern Bounds in Non-Abelian Quantum Geometry](https://arxiv.org/abs/2608.12221)
...
### [38] [Exact solution for stationary states of a closed memristor with mobile charged vacancies](https://arxiv.org/abs/2608.12264)
...
### [39] [Wormhole Geometry from a Magnetic Vortex](https://arxiv.org/abs/2608.12285)
...
### [40] [Discriminating superconducting fluctuations from the pseudogap in Bi$_2$Sr$_2$Ca$_{n-1}$Cu$_n$O$_{2n+4+δ} (n = 2,3)$: A magnetotransport study](https://arxiv.org/abs/2608.11284)
...
### [41] [Light induced superconducting diode effect in patterned films](https://arxiv.org/abs/2608.11331)
...
### [42] [Yttrium Superhydrides Revisited: Advanced Experimental and Theoretical Studies of YH$_6$, YH$_9$ and YH$_{10}$](https://arxiv.org/abs/2608.11428)
...
### [43] [Acoustic Plasmon Resonance: Breaking the Anderson Stiffness Paradigm in Quasi-Two-Dimensional Superconducting Films](https://arxiv.org/abs/2608.11610)
...
### [44] [Thickness-Driven Superconductor-Insulator Transition in (Cu,C)-1234 and Proximity-Induced Superconductivity Recovery in (Cu,C)-1234/YBCO Heterostructure](https://arxiv.org/abs/2608.11707)
...
### [45] [Spin-polarized supercurrents and Josephson diode effect in altermagnets](https://arxiv.org/abs/2608.11906)
