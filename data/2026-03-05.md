...
### [1] [Enhanced superconductivity in palladium hydrides by non-perturbative electron-phonon effects](https://arxiv.org/abs/2603.03492)
...
### [2] [Limited coincidence between ultrahigh-field superconductivity and line of metamagnetic endpoints in UTe$_2$](https://arxiv.org/abs/2603.03500)
...
### [3] [Electrostatically-induced topological phase transitions in polyacetylene molecules](https://arxiv.org/abs/2603.03473)
...
### [4] [Graphene Zero-Bias Sub-Terahertz Turnkey Detector with Above 43 GHz Bandwidth](https://arxiv.org/abs/2603.03554)
...
### [5] [Analysis of an all-to-all connected star array of transmon qubits](https://arxiv.org/abs/2603.03586)
*Ricardo A. Pinto*
...
### [6] [Symmetry selection rules for the intrinsic nonlinear thermal Hall effect in altermagnets: Role of quantum metric and $C_{2}$ rotational symmetry](https://arxiv.org/abs/2603.03599)
*Gunn Kim*
...
### [7] [Impact of the out-of-plane conductivity on spin transport evaluation in a van der Waals material](https://arxiv.org/abs/2603.03609)
...
### [8] [Coulomb interaction unlocks Majorana-mediated electron teleportation between Quantum dots](https://arxiv.org/abs/2603.03699)
...
### [9] [Multimode cavity magnonics in mumax+: from coherent to dissipative coupling in ferromagnets and antiferromagnets](https://arxiv.org/abs/2603.03706)
...
### [10] [Non-reciprocity and exchange-spring delay of domain-wall Walker breakdown in magnetic nanowires with azimuthal magnetization](https://arxiv.org/abs/2603.03715)
...
### [11] [Imaging asymmetric Coulomb blockade phenomena across metallic nanoislands](https://arxiv.org/abs/2603.03783)
...
### [12] [Demonstration of robust chiral edge transport in Chern insulator MnBi2Te4 devices with engineered geometric defects](https://arxiv.org/abs/2603.03927)
...
### [13] [Trainable Neuromorphic Spintronic Hardware Via Analog Finite-Difference Gradient Methods](https://arxiv.org/abs/2603.03947)
...
### [14] [Probing pure spin-rotation quantum geometry in persistent spin textures via nonlinear transport](https://arxiv.org/abs/2603.04023)
...
### [15] [Interfering trajectories in a ballistic Andreev cavity](https://arxiv.org/abs/2603.04046)
...
### [16] [Generating Exceptional Knots and Links with Arbitrary Braiding Topology](https://arxiv.org/abs/2603.04143)
...
### [17] [Progress on artificial flat band systems: classifying, perturbing, applying](https://arxiv.org/abs/2603.04248)
...
### [18] [Ab initio study of saddle-point excitons in monolayer SnS2](https://arxiv.org/abs/2603.04294)
...
### [19] [Hanle lineshapes and spin-rotation signatures from in-plane anisotropic spin relaxation in heterogeneous spin devices](https://arxiv.org/abs/2603.04297)
...
### [20] [Sub-wavelength mid-infrared imaging of locally driven photocurrents using diamond campanile probes](https://arxiv.org/abs/2603.04318)
...
### [21] [TritonDFT: Automating DFT with a Multi-Agent Framework](https://arxiv.org/abs/2603.03372)
...
### [22] [Quantum Theory of Functionally Graded Materials](https://arxiv.org/abs/2603.03424)
...
### [23] [Strain effects on $n$-type doping in AlN](https://arxiv.org/abs/2603.03528)
...
### [24] [Probing Interface-Driven Mechanisms of Non-Classical Light in van der Waals Heterostructures](https://arxiv.org/abs/2603.03534)
...
### [25] [Predicting Spin-Crossover Behavior in Metal-Organic Frameworks from Limited and Noisy Data Using Quantile Active Learning](https://arxiv.org/abs/2603.03545)
...
### [26] [A Pathway Selection Process for Dynamically Self-Organizing Systems](https://arxiv.org/abs/2603.03557)
*J. A. Sekhar*
...
### [27] [Plasmonic polaron in self-intercalated 1T-TiS2](https://arxiv.org/abs/2603.03663)
...
### [28] [Nonvolatile Control of Nonlinear Hall and Circular Photogalvanic Effects via Berry Curvature Dipole in Multiferroic Monolayer CrNBr2](https://arxiv.org/abs/2603.03670)
...
### [29] [Insights into hydrogen-induced vacancy stability and creep in chemically complex alloys](https://arxiv.org/abs/2603.03707)
...
### [30] [Ultralow and Tunable Thermal Conductivity of Parylene C for Thermal Insulation in Advanced Packaging](https://arxiv.org/abs/2603.03737)
...
### [31] [Remote Plasma Polymers of Iron (II) Phthalocyanine in Polyacrylonitrile-Derived Carbon Electrospun Fibers as Electrode for Supercapacitors](https://arxiv.org/abs/2603.03900)
...
### [32] [Hydrostatic Pressure Driven Band Gap Tuning and Self-Trapped Exciton Formation in (4FPEA)$_2$SnBr$_{4}$ Halide Perovskite](https://arxiv.org/abs/2603.03931)
...
### [33] [Machine learning assisted High-Throughput study of M$_4$X$_3$T$_x$ MXenes](https://arxiv.org/abs/2603.04103)
...
### [34] [Dispersion and lifetimes of magnons in non-collinear magnets from time dependent density functional theory](https://arxiv.org/abs/2603.04111)
...
### [35] [Nine-element machine-learned interatomic potentials for multiphase refractory alloys](https://arxiv.org/abs/2603.04147)
...
### [36] [Machine-learned Interatomic Potential for Ti$_{n+1}$C$_n$ MXenes: Application to Ion Irradiation Simulations](https://arxiv.org/abs/2603.04152)
*Jesper Byggmästar*
...
### [37] [Chemical Vapor Deposition of Epitaxial Chromium Nitride Thin Films](https://arxiv.org/abs/2603.04154)
...
### [38] [Electronic and structural properties of V$_2$O$_5$ layered polymorphs](https://arxiv.org/abs/2603.04193)
...
### [39] [The effect of chemical vapor infiltration process parameters on flexural strength of porous α-SiC: A numerical model](https://arxiv.org/abs/2603.04287)
...
### [40] [Study on the Effect of Annealing on Ga$_2$O$_3$ Thin Films Deposited on Silicon by RF Sputtering](https://arxiv.org/abs/2603.04327)
