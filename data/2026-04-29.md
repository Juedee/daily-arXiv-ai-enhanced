...
### [7] [Absence of Quasi-Majorana False Positives in Full-Shell Hybrid Nanowires](https://arxiv.org/abs/2604.24858)
...
### [8] [Dispersion of Anyon Bloch Bands](https://arxiv.org/abs/2604.24859)
...
### [9] [Probing Spin Dynamics Across Magnetic Phase Transitions in CrCl3 Nanoflakes Using Nitrogen-Vacancy Microscopy](https://arxiv.org/abs/2604.25002)
...
### [10] [Femtosecond tunneling spectroscopy of ultrafast band bending dynamics at the atomic limit](https://arxiv.org/abs/2604.25146)
...
### [11] [Anomalous Mixed-State Floquet Topology in One-Dimensional Open Quantum Systems](https://arxiv.org/abs/2604.25248)
...
### [12] [Synthetic Polariton Matter in the solid state](https://arxiv.org/abs/2604.25413)
*Sylvain Ravets*
...
### [13] [Temporal hopping dynamics in exciton-polariton condensation](https://arxiv.org/abs/2604.25519)
...
### [14] [Doping-Induced Brightening of Dark Excitons and Trions in a WSe$_2$ Monolayer](https://arxiv.org/abs/2604.25553)
...
### [15] [Magnomechanical Coupling in Suspended 2D van der Waals Ferromagnets](https://arxiv.org/abs/2604.25588)
...
### [16] [Binary topological logic gates in Kane-Mele nanostructures via local control of edge-state transport](https://arxiv.org/abs/2604.25633)
*K. Zberecki*
...
### [17] [Magnetoplasma excitations in interacting GaAs disks](https://arxiv.org/abs/2604.25736)
...
### [18] [Linear response from tilted Dirac cones under strain-induced pseudomagnetic fields](https://arxiv.org/abs/2604.25758)
...
### [19] [3D integration of a hybrid quantum dot circuit-QED device for fast gate dispersive charge readout and coherent spin-photon coupling](https://arxiv.org/abs/2604.25871)
...
### [20] [Trillion-atom molecular dynamics simulations with ab initio accuracy](https://arxiv.org/abs/2604.24816)
...
### [21] [Visualizing Crystallization Dynamics and Transformation Pathways of Disordered Rocksalt Oxides During Thermally Activated Sol-Gel Synthesis](https://arxiv.org/abs/2604.24941)
...
### [22] [Influence of Heterogeneity on the Response of Architected Metamaterials](https://arxiv.org/abs/2604.25075)
...
### [23] [Ultrafast Energy Absorption in Silicon Controlled by Two-Color Double Pulses](https://arxiv.org/abs/2604.25093)
...
### [24] [Determination of the Fermi Energy of Diamond using Photoluminescence Spectral Analysis](https://arxiv.org/abs/2604.25097)
...
### [25] [Electric-field control of hydrogen bonding via interfacial charge at atomic resolution](https://arxiv.org/abs/2604.25114)
...
### [26] [Kohn-Sham Hamiltonian from Effective Field Theory: Quasiparticle Band Narrowing from Frozen Core Dynamics](https://arxiv.org/abs/2604.25199)
...
### [27] [Benchmarking Universal Machine-Learned Interatomic Potentials for High-Temperature Metal-Organic Framework Chemistry](https://arxiv.org/abs/2604.25262)
...
### [28] [Reversible Modulation of Thermal Conductivity in GaN via Strain-Driven Reorganization of Dislocation Ensembles](https://arxiv.org/abs/2604.25287)
...
### [29] [Proximity Ferroelectricity Driven by Mobile High-Miller-Index Domain Walls](https://arxiv.org/abs/2604.25343)
...
### [30] [Determination of Burgers vectors of dislocations in monoclinic $β$-Ga$_2$O$_3$ crystals by large-angle convergent-beam electron diffraction](https://arxiv.org/abs/2604.25428)
...
### [31] [Physical properties of transition metal hydride superconductors Mg2TmH6 (Tm = Rh, Pd, Ir, Pt) by first-principles calculations](https://arxiv.org/abs/2604.25626)
...
### [32] [From Ultrafast Demagnetization to Ultrafast Spintronics : a 30 years story](https://arxiv.org/abs/2604.25431)
...
### [33] [Thermodynamic surface reconstruction governs catalytic behavior in high-entropy alloys](https://arxiv.org/abs/2604.25454)
...
### [34] [Probing sliding ferroelectricity in bilayer T$_\mathrm{d}$-WTe$_2$ with high-harmonic generation](https://arxiv.org/abs/2604.25483)
...
### [35] [Electronic structures of spin-orbit-coupled metal candidate PbRe$_2$O$_6$: one dimensionality and molecular orbital formation](https://arxiv.org/abs/2604.25539)
...
### [36] [Benchmarking bandgap prediction in semiconductors under experimental and realistic evaluation settings](https://arxiv.org/abs/2604.25568)
...
### [37] [Tuning magnitude and direction of lattice thermal conductivity in transition metal dichalcogenide heterobilayers](https://arxiv.org/abs/2604.25576)
...
### [38] [Substitutional platinum as an efficient nonradiative recombination center in silicon](https://arxiv.org/abs/2604.25621)
...
### [39] [Spin-Axis-Layer Locking for Intrinsic Bipolar Altermagnetic Semiconductors: Proof-of-Concept in Bilayer CuBr2](https://arxiv.org/abs/2604.25658)
...
### [40] [Chemical transformation of MgH2/V2O5 composite to Mg-V-O rock salt and its influence on the electrochemical Li conversion and hydrogen storage characteristics of MgH2](https://arxiv.org/abs/2604.25718)
...
### [41] [Predicting challenging phase transitions with Bayesian active learning](https://arxiv.org/abs/2604.25756)
...
### [42] [Global DIC-based sample-detector geometry refinement for accurate EBSD indexing](https://arxiv.org/abs/2604.25869)
...
### [43] [Structure Prediction and Bonding Analysis of B$_{18}$Ag$_2$ Clusters Featuring Double-Ring Motifs](https://arxiv.org/abs/2604.25908)
