...
### [4] [Fermi Surface Geometry from Charge Fluctuations in Three-Dimensional Metals](https://arxiv.org/abs/2605.13951)
...
### [5] [Switchable Surface Linear Photogalvanic Effect in the Magnetic Weyl Semimetal Co3Sn2S2](https://arxiv.org/abs/2605.14107)
...
### [7] [Spin Hall effect in electronic Lévy glasses: Enhanced spin current generation in the superdiffusive regime](https://arxiv.org/abs/2605.14214)
...
### [8] [Engineering Delocalization in Graphene Nanoribbons via Quasiperiodic Edges and Electronic Interactions](https://arxiv.org/abs/2605.14216)
...
### [10] [Periodic Behavior of Topology in Graphene with Nanohole Array](https://arxiv.org/abs/2605.14436)
...
### [11] [Spin resolved spectral topology and re-entrant localization in a non Hermitian quasiperiodic SSH chain](https://arxiv.org/abs/2605.14639)
*Hemant K Sharma*
...
### [12] [Compositional and Magnetic Characterisation of Oblique Co and Fe Nanowire Structures Fabricated Using Focused Electron Beam Induced Deposition](https://arxiv.org/abs/2605.14673)
...
### [13] [Anisotropic Surface Spin Waves as Signature of A-type Altermagnets](https://arxiv.org/abs/2605.14735)
...
### [14] [Optimizing strong light-matter coupling of plasmonic lattices and monolayer semiconductors](https://arxiv.org/abs/2605.14767)
...
### [15] [Resonant optical cooling of nuclear spins in case of strong Knight field of photoexcited electrons](https://arxiv.org/abs/2605.14934)
*Kirill Kavokin*
...
### [16] [Current induced magneto-optical Kerr effect as a probe of Dirac carriers in Bi$_{1-x}$Sb$_x$ alloy](https://arxiv.org/abs/2605.14975)
...
### [17] [Impurity-induced geometric correlations and fractional quantization in quantum Hall systems](https://arxiv.org/abs/2605.15022)
*M. A. Hidalgo*
...
### [19] [A Neural-Network Framework to Learn History-Dependent Constitutive Laws and Identifiability of Internal Variables](https://arxiv.org/abs/2605.14179)
...
### [35] [Agentic Design of Compositional Descriptors via Autoresearch for Materials Science Applications](https://arxiv.org/abs/2605.14671)
...
### [36] [Telecom-Wavelength-Compatible Quantum Information Transcription Using Nitrogen-Vacancy Centers](https://arxiv.org/abs/2605.14697)
...
### [37] [Thermal expansion of FeWO$_4$ (Ferberite) and FeWO$_4$:Fe$_2$WO$_6$ (7:1): a comparative X-ray and neutron diffraction study](https://arxiv.org/abs/2605.14792)
...
### [38] [Melting Behavior and Phase Stability of CaO from Neural Network Potentials: a Molecular Dynamics Study](https://arxiv.org/abs/2605.14793)
...
### [39] [Generative reconstruction of 2D and 3D polycrystalline microstructures using symmetrized hyperspherical harmonics](https://arxiv.org/abs/2605.14898)
...
### [40] [The Emergence of Photonic Crystalline Order and Time-Series Dynamics in NaCl Droplet Deposition](https://arxiv.org/abs/2605.15101)
...
### [41] [Limitations of Debye-Waller lattice temperature extraction under electronic excitation](https://arxiv.org/abs/2605.15140)
