...
### [1] [Modeling phase separation in polymer-derived carbonitride ceramics through extended machine learning molecular dynamics](https://arxiv.org/abs/2605.20358)
...
### [3] [Evaluating Blended Refrigerants for Thermochemical Energy Storage and Circular Refrigerant Recovery using Activated Carbons](https://arxiv.org/abs/2605.20446)
...
### [4] [Sub-10 mK "In-cell" Magnetic Refrigeration for Cryogen-free Cryostats](https://arxiv.org/abs/2605.20462)
...
### [5] [The Dislocation Content of Triple Junctions](https://arxiv.org/abs/2605.20575)
...
### [6] [Interacting donor-acceptor pairs as the origin of coupled spin-optical signals in hexagonal boron nitride](https://arxiv.org/abs/2605.20655)
...
### [7] [Tuning the low-energy band structure in twisted bilayer WSe2](https://arxiv.org/abs/2605.20671)
...
### [8] [Generalized Phase Diagrams for Graphene CVD growth on Copper](https://arxiv.org/abs/2605.20783)
...
### [9] [Anisotropic Crystallization Kinetics and Interfacial Dynamics of Phase-Change Material Sb$_2$S$_3$ from Machine Learning Force Field Simulations](https://arxiv.org/abs/2605.20785)
...
### [10] [Transferable 3D Convolutional Neural Networks for Elastic Constants Prediction in Nanoporous Metals](https://arxiv.org/abs/2605.20890)
...
### [13] [Shear-Mode Raman Imaging of Ferroelectric Switching in Multilayer 3$R$-MoS$_2$](https://arxiv.org/abs/2605.21210)
...
### [14] [In-Plane Ferromagnetism and Critical Dynamics in Alkali-Deficient K$_{1-x}$CrTe$_2$ (with $x \approx$ 0.3) Single Crystals](https://arxiv.org/abs/2605.20972)
...
### [15] [Occupation Dynamics of Floquet-Volkov States and Spectral Sum Rule](https://arxiv.org/abs/2605.21339)
...
### [16] [Multiferroic Properties of Electrospun CFO-BCTSn Nanocomposites for Magnetoelectric and Magnetic Field Sensing Applications](https://arxiv.org/abs/2605.20986)
...
### [17] [Ultra-Confinement of Polaritons in Single Atomic Layer Ag Photonic Quantum Dots](https://arxiv.org/abs/2605.21345)
...
### [18] [Attached Split Ring Resonator Cavity for Magnon Photon Coupling](https://arxiv.org/abs/2605.21004)
...
### [19] [Pulse-Driven Reconfiguration of Fractional Polar Topology in Zr-Substituted Barium Titanate](https://arxiv.org/abs/2605.21368)
*Florian Mayer*
...
### [21] [Observation of spin-free interatomic orbital angular momentum in a chiral crystal](https://arxiv.org/abs/2605.21124)
...
### [22] [Oxygen-Pressure-Limited Recovery of the Hematite α-Fe$_2$O$_3$(0001) Surface from a Reduced Fe$_3$O$_4$(111)-Like Layer](https://arxiv.org/abs/2605.21176)
...
### [23] [Ligand-mediated Origin of Altermagnetic Spin-Splitting](https://arxiv.org/abs/2605.21284)
...
### [24] [Ferroelectric KNbO3 nanoplatelets for thermally driven pyrocatalytic hydrogen evolution and dye degradation](https://arxiv.org/abs/2605.21302)
...
### [25] [Unconventional Magnetism: Symmetry Classification, Hybrid-parity and Unconstrained-parity Classes](https://arxiv.org/abs/2605.21336)
...
### [26] [Phonon Interactions in Metal Halide Perovskites elucidated by Raman Scattering](https://arxiv.org/abs/2605.21415)
*Alejandro R. Goñi*
...
### [27] [Hybrid Improper Ferroelectricity and Moiré Superlattices-induced Exciton Quantization in Layered 2D Halide Perovskite](https://arxiv.org/abs/2605.21449)
...
### [28] [Superconducting PdTe Thin Film Via Topotactic Transformation, Toward Topological Superconductors](https://arxiv.org/abs/2605.20437)
...
### [29] [Pressure-induced superconductivity in epitaxially-stabilized Pr$_3$Ni$_2$O$_7$ films](https://arxiv.org/abs/2605.20653)
...
### [30] [Carrier-doping effect and anomalous transport properties in Ni-doped CeCoIn5 investigated by Hall resistivity measurements](https://arxiv.org/abs/2605.20685)
...
### [31] [Multiple Superconducting Phases in Palladium Deuteride Induced by Nuclear-Spin Isotope Effect](https://arxiv.org/abs/2605.20966)
...
### [32] [An AI-driven robotic system for two-dimensional hetero-assemblies](https://arxiv.org/abs/2605.20420)
...
### [33] [Fröhlich-type Polarons in Isotopically Enriched Hexagonal Boron Nitride](https://arxiv.org/abs/2605.20428)
...
### [34] [Excitation-Energy-Selective Control of Hot-Carrier Cooling via a Resonant Optical-Phonon Bottleneck in Graphene](https://arxiv.org/abs/2605.20430)
...
### [35] [Coexisting Ballistic and Diffusive Heat Transport in Micrometer-Scale Molecular Junctions](https://arxiv.org/abs/2605.20517)
...
### [36] [Field-tunable spin-valley transport in monolayer MoS$_2$](https://arxiv.org/abs/2605.20790)
...
### [37] [The Topography Trap: Sifting Interlayer Excitons from Strain-Related Artifacts in Real-World 2D Hetrostructures](https://arxiv.org/abs/2605.20869)
...
### [38] [Spin Peltier effect in graphene](https://arxiv.org/abs/2605.21087)
...
### [39] [Probing topological phase transitions via nonlinear Hall response in strained moiré dice lattice](https://arxiv.org/abs/2605.21229)
...
### [40] [Destructive interference of second harmonic generation in AA stacked MoTe$_2$/WSe$_2$](https://arxiv.org/abs/2605.21231)
...
### [41] [Stacking-order-dependent electronic properties of MoTe2/WSe2 moiré bilayers](https://arxiv.org/abs/2605.21233)
...
### [42] [Designer Quantum States in Magnetic Topological Insulator Multilayers](https://arxiv.org/abs/2605.21287)
...
### [43] [Designing Magnetic Topological Insulator Trilayers for Highly-Efficient Spin-Orbit Torque Switching](https://arxiv.org/abs/2605.21297)
...
### [44] [Huge ultrafast spin Seebeck effect mediated by laser-excited superdiffusive magnon currents](https://arxiv.org/abs/2605.21389)
