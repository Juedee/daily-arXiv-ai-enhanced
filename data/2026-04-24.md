...
### [13] [Evolution of the Saddle Point in Antimony Telluride Homologous Superlattices](https://arxiv.org/abs/2604.21037)
...
### [14] [Expanding the extreme-k dielectric materials space through physics-validated generative reasoning](https://arxiv.org/abs/2604.21068)
...
### [15] [Accelerating point defect simulations using data-driven and machine learning approaches](https://arxiv.org/abs/2604.21069)
...
### [16] [Generative Discovery of Magnetic Insulators under Competing Physical Constraints](https://arxiv.org/abs/2604.21073)
...
### [17] [Neutron and X-ray Diffraction Reveal the Limits of Long-Range Machine Learning Potentials for Medium-Range Order in Silica Glass](https://arxiv.org/abs/2604.21222)
...
### [18] [Velocity-field characteristics and device performance in nanoscale amorphous oxide Thin-Film-Transistors](https://arxiv.org/abs/2604.21225)
...
### [19] [Electrically switchable vacancy state revealed by in-operando positron experiments](https://arxiv.org/abs/2604.21283)
...
### [20] [Room-temperature third-order nonlinear anomalous Hall effect in ferromagnetic metal Fe3GaTe2](https://arxiv.org/abs/2604.21285)
...
### [21] [Navigating Order-(Dis)Order Family Trees via Group-Subgroup Transitions](https://arxiv.org/abs/2604.21386)
...
### [22] [Identifying Oriented Spin Space Groups and Related Physical Properties Using an Online Platform FINDSPINGROUP](https://arxiv.org/abs/2604.21397)
...
### [23] [Intertwined charge density wave, tunable anti-dome superconductivity, and topological states in kagome metal VSn](https://arxiv.org/abs/2604.21488)
...
### [24] [GEWUM: General Exploration Workflow for the Utopia of Materials: A Unified Platform for Automated Structure Generation, Selection, and Validation](https://arxiv.org/abs/2604.21401)
...
### [25] [Single-crystal growth and magnetic, magnetoelectric, and optical properties of ferroaxial-type SrMn$_2$Ni$_6$Te$_3$O$_{18}$](https://arxiv.org/abs/2604.21460)
...
### [26] [Data-Driven Thermal and Mechanical Modeling of Defective Covalent Organic Frameworks](https://arxiv.org/abs/2604.21494)
...
### [27] [Emergence of a non-bulk hexagonal Fe$_2$S$_2$ single layer via phase transformation](https://arxiv.org/abs/2604.21613)
...
### [28] [Self-consistent evaluation of the Berry connection for Wannier functions](https://arxiv.org/abs/2604.21660)
...
### [29] [Nickel intercalation in epitaxial graphene on SiC(0001): a novel platform for engineering two-dimensional heterostructures](https://arxiv.org/abs/2604.21739)
...
### [30] [Neural surrogates for crystal growth dynamics with variable supersaturation: explicit vs. implicit conditioning](https://arxiv.org/abs/2604.21753)
...
### [31] [Electronic and Vibrational Properties of On-Surface Synthesized Gulf-Edged Chiral Graphene Nanoribbons](https://arxiv.org/abs/2604.21796)
...
### [32] [Amorphous Nanoconfinement Enables Self-sustaining Sabatier Reaction at Ambient Conditions](https://arxiv.org/abs/2604.21768)
...
### [33] [Nearly Complete Charge--Spin Conversion via Strain-Eliminated Fermi Pockets in a $d$-Wave Altermagnet](https://arxiv.org/abs/2604.21779)
...
### [34] [Direct observation of surface bandgap shrinkage and negative electronic compressibility in SrTiO3](https://arxiv.org/abs/2604.21783)
...
### [37] [Critical role of phase-dependent properties in modeling photothermal sintering of LiCoO2 cathodes](https://arxiv.org/abs/2604.21842)
...
### [38] [OptiMat Alloys: A FAIR End-to-End Agent with Living Database for Computational Multi-Principal Alloy Exploration](https://arxiv.org/abs/2604.21850)
...
### [39] [Extending Hamiltonian-Adaptive Resolution Simulation to Interfaces: An Updated LAMMPS Implementation and Application to Porous Solids](https://arxiv.org/abs/2604.21867)
...
### [40] [Healing of topological defects while crystallizing nanocrystals](https://arxiv.org/abs/2604.21105)
...
### [41] [Controlled Manipulation of Intermediate State in a Type-I Superconductor](https://arxiv.org/abs/2604.21499)
...
### [42] [Pairing mechanism and superconductivity in 1313 phase La$_3$Ni$_2$O$_7$](https://arxiv.org/abs/2604.21533)
...
### [43] [Superconductivity induced by altermagnetic spin fluctuations in high-pressure MnB$_4$](https://arxiv.org/abs/2604.21561)
...
### [44] [Two-gap to Single-gap Transition and Two-dome-like Superconductivity in Alkali-Metal Intercalated Bilayer PdTe2](https://arxiv.org/abs/2604.21635)
...
### [45] [Effect of Mn Substitution on Superconductivity in PrFeAs(O,F): Role of Magnetic Impurities](https://arxiv.org/abs/2604.21684)
...
### [46] [$3d_{z^2}$ orbital delocalization and magnetic collapse in superconducting (La,Pr)$_3$Ni$_2$O$_{7-δ}$ films](https://arxiv.org/abs/2604.21899)
