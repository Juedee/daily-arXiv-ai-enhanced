...
### [1] [Chiral anomaly and planar Hall conductance in pseudospin-$1$ Fermions](https://arxiv.org/abs/2606.11364)
*Azaz Ahmad*
...
### [2] [Extrinsic quantum geometry in the quadrupolar bulk photovoltaic effect](https://arxiv.org/abs/2606.11434)
...
### [3] [Polarization-Resolved Photon Statistics of Cavity Quantum Materials](https://arxiv.org/abs/2606.11550)
...
### [4] [Consistent Evaluation of Operators Involving the Position Operator in the Bloch Representation: Application to the Orbital Moment](https://arxiv.org/abs/2606.11679)
...
### [5] [DSpinGNN: A Physics-Informed Equivariant Graph Neural Network for Dynamic Magnetic Exchange Prediction in Strain-Deformed Monolayer CrI$_3$](https://arxiv.org/abs/2606.11685)
...
### [6] [Spin-Orbit Torque and Magnetization Switching in 2D Ferromagnetic Devices](https://arxiv.org/abs/2606.11752)
...
### [7] [Berry-phase-based Topological Charge in Quasicrystals and their Observable Features in Photonic System](https://arxiv.org/abs/2606.11777)
...
### [8] [Ferroelectric Altermagnetic Chern Insulator in magnetic field: electrical control of the Chern number](https://arxiv.org/abs/2606.11862)
...
### [9] [Intrinsic Nonreciprocity in Electron-Phonon Interaction Driven Thermoelectric Diodes](https://arxiv.org/abs/2606.11904)
...
### [10] [Robust Spin Logic Enabled by Generalized $\mathrm{SU}(2)$ Symmetry in $p$-Wave Magnets](https://arxiv.org/abs/2606.11912)
...
### [11] [Reflective Metastructure Q-plate for Ultrashort Laser Pulses](https://arxiv.org/abs/2606.12041)
...
### [12] [Heisenberg-Langevin theory of an exciton mirror](https://arxiv.org/abs/2606.12053)
*Sergueï V. Andreev*
...
### [13] [Experimental straintronics in nanotube quantum dots](https://arxiv.org/abs/2606.12180)
...
### [15] [Stacking switching between correlation-protected radial Rashba field and persistent spin textures in graphene encapsulated by 1T-TaS$_2$ monolayers](https://arxiv.org/abs/2606.12239)
...
### [16] [Gate-tunable spin-valley transport via carrier velocity in monolayer WSe$_2$](https://arxiv.org/abs/2606.12353)
...
### [17] [Reconfigurable Strain Gradient Polarity in Crystalline Oxide Nanomembranes for Controlled Bending of Functional Materials](https://arxiv.org/abs/2606.11370)
...
### [18] [Defect Tolerance in Trigonal Selenium Photovoltaics](https://arxiv.org/abs/2606.11403)
...
### [19] [Topological Phase Transition in Mechanical Honeycomb Lattice](https://arxiv.org/abs/2606.11427)
...
### [20] [Screening of the Coulomb interaction in Carbon Nanotubes: A First-Principles cRPA study](https://arxiv.org/abs/2606.11441)
...
### [21] [Nucleation instability preempts relativistic domain wall transport in high-exchange ferrimagnetic nanowires](https://arxiv.org/abs/2606.11488)
*Pietro Diona*
...
### [22] [Chiral Magnons and Cycloidal Phonons in Altermagnetic CuF$_{2}$ Monolayer](https://arxiv.org/abs/2606.11584)
...
### [23] [Unveiling Orbital-mediated Ultrafast Demagnetization in Rare Earth-Transition-Metal Ferrimagnets](https://arxiv.org/abs/2606.11591)
...
### [24] [Observation of coherently modulated phonon band and lifetime in superlattice](https://arxiv.org/abs/2606.11696)
...
### [25] [Integrated magnonic neural circuits based on nonlinear wave neurons](https://arxiv.org/abs/2606.11703)
...
### [26] [Bulk-like Compressibility of the Au-Au Metallic Bond in the Atomically Precise $\mathrm{Au}_{25}$ Cluster](https://arxiv.org/abs/2606.11802)
...
### [27] [Modelling magnetic material properties with uncertainty-aware neural networks](https://arxiv.org/abs/2606.11870)
...
### [28] [Sonochemically Boosted Hydrogen Evolution Activity of Janus TMD Monolayers](https://arxiv.org/abs/2606.11873)
...
### [29] [Spin-Polarized Electronic Structure and Chemical Bonding Data for 2,500+ Halide Double Perovskites](https://arxiv.org/abs/2606.11928)
...
### [30] [Boron Co-Alloying in AlScN Wurtzite Ferroelectrics: Insights from an 850-Sample Combinatorial Study](https://arxiv.org/abs/2606.11954)
...
### [31] [Interfacial Coupling and Sparse Intercalation of 7-Atom-Wide Armchair Graphene Nanoribbons by N-Heterocyclic Carbene Monolayers](https://arxiv.org/abs/2606.11973)
...
### [32] [Coupling Chirality, Polar Order, and Altermagnetic Spin Splitting in a Hybrid Manganese Chloride](https://arxiv.org/abs/2606.11985)
...
### [33] [Residual stress gradient in a thin film within the dislocation pile-up theory](https://arxiv.org/abs/2606.12007)
...
### [34] [In Situ Dynamics of the Microscopic Crystallographic Dehydration Pathway in a Model Channel Hydrate, Theophylline](https://arxiv.org/abs/2606.12029)
...
### [35] [Multilayer Screening of Double and Conventional Perovskite Solar Cells Using SCAPS-1D and Machine Learning: Optimization of ETL, HTL, and Absorber for High-Efficiency Architectures](https://arxiv.org/abs/2606.12083)
...
### [36] [Direct nanoscale observation of melting and solute redistribution in a hypoeutectic Al-Cu alloy with in situ STEM](https://arxiv.org/abs/2606.12107)
...
### [37] [Scalable Conformal MoSx Catalyst for Efficient Hydrogen Evolution at Industrial-Level Current Density in Alkaline Electrolyzers](https://arxiv.org/abs/2606.12110)
...
### [38] [All-electric picosecond field-free spin-orbit torque switching in magnetic trilayers](https://arxiv.org/abs/2606.12122)
...
### [39] [Tracking atomic-scale interdiffusion in immiscible bimetallic nanoparticles via four-dimensional electron tomography](https://arxiv.org/abs/2606.12150)
...
### [40] [Quantum dynamic simulation of triplet formation in an effective model of Y6 (BTP-4F)](https://arxiv.org/abs/2606.12221)
...
### [41] [Thermodynamically consistent phase field model for hydrogen-assisted cracking](https://arxiv.org/abs/2606.12238)
...
### [42] [Plasmonic properties and correlation energies from a compact multipole representation of the dielectric response in 2D metals](https://arxiv.org/abs/2606.12274)
...
### [43] [Effect of polar distortions on the anomalous Hall conductivity of altermagnetic $α$-MnTe](https://arxiv.org/abs/2606.12311)
...
### [44] [Superconductivity near quarter- and half-filling of a strongly correlated triangular Hubbard band in twisted trilayer WSe2](https://arxiv.org/abs/2606.11495)
...
### [45] [Unveiling the Interplay of Charge and Magnetic Excitations in HgBa$_2$Ca$_2$Cu$_3$O$_{8+δ}$](https://arxiv.org/abs/2606.11524)
...
### [46] [Ambient and Pressure Dependent Superconductivity with Hydrogen Storage Potential in Quaternary Hydride LiMgZr2H12: A Comprehensive First-principles Insights](https://arxiv.org/abs/2606.11721)
...
### [47] [Mathematical Basis for Analyzing Superconducting Phase Transitions Using Catastrophe Theory](https://arxiv.org/abs/2606.11810)
...
### [48] [Proximity-induced unconventional superconductivity and chiral topological phases in twisted graphene/NbSe$_2$ van der Waals heterostructure](https://arxiv.org/abs/2606.12104)
...
### [49] [Structural Changes and Transport Properties of $\mathrm{YBa_2Cu_3O_7}$ Locally Modified by a He$^+$ Focused Ion Beam](https://arxiv.org/abs/2606.12145)
...
### [50] [Superconductivity in the pressure-amorphized topological insulator CrP$_4$](https://arxiv.org/abs/2606.12241)
...
### [51] [Substrate insulated Josephson junctions for superconducting quantum circuits](https://arxiv.org/abs/2606.12262)
