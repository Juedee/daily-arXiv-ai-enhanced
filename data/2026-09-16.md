...
### [1] [Topological superconductors and Majorana fermions based on $X$-wave magnets with $X=p,d,f,g,i $](https://arxiv.org/abs/2609.16084)
*Motohiko Ezawa*
...
### [2] [Optical and magnetic signatures of drive-enhanced coherence in phase-disordered superconducting bilayers](https://arxiv.org/abs/2609.16137)
...
### [3] [Mode-selective phonon effects on magnetism and superconductivity in trilayer nickelates](https://arxiv.org/abs/2609.16143)
...
### [4] [Current - voltage characteristics in magnetic field for layered superconductor with intrinsic pinning of Josephson vortices](https://arxiv.org/abs/2609.16277)
...
### [5] [NaFeP: first pairing prediction for an unmade 111 iron phosphide, and the pnictogen-height rule inside one compound](https://arxiv.org/abs/2609.17028)
*Reinaldo Inácio*
...
### [6] [Interplay of dimerization and quasiperiodicity in the superconducting proximity effect of a one-dimensional hybrid ring](https://arxiv.org/abs/2609.17069)
...
### [7] [Two-Dimensional Materials toward CMOS-Compatible Scalable Quantum Hardware](https://arxiv.org/abs/2609.16172)
...
### [8] [Breaking the Wiedemann-Franz limit in thermoelectrics via separated flat bands](https://arxiv.org/abs/2609.16261)
...
### [11] [Nonlinear electron-phonon interactions from first principles](https://arxiv.org/abs/2609.17433)
...
### [13] [Symbolic Ensemble Learning Enables Discovery of Fast Accurate Physics-Based Interatomic Potentials](https://arxiv.org/abs/2609.16526)
...
### [14] [Orbital-resolved superexchange and topological magnon bands in MXene Fe$_2$C](https://arxiv.org/abs/2609.16530)
...
### [15] [Exotic centrosymmetric phase of acentric urea under high pressure](https://arxiv.org/abs/2609.16545)
...
### [16] [Origin and Reduction of Coercive Fields in ZnO-based Wurtzite Ferroelectrics](https://arxiv.org/abs/2609.16570)
...
### [17] [Nonlinear Photocurrent Spectroscopy and Polarization-Tunable Shift Current in the Layered Semiconductor $\mathrm{CuScP_2S_6}$](https://arxiv.org/abs/2609.16577)
...
### [18] [Application of Regional Chemical Potential Analysis to Si Adsorption on the Diamond (001) Surface](https://arxiv.org/abs/2609.16620)
...
### [19] [Total-energy-assisted Tight-binding Method Based on Density Functional Theory - Design Principles toward Transferability and Extrapolation](https://arxiv.org/abs/2609.16649)
...
### [20] [Electrical Probing of Sub-Néel Spin Dynamics in Two-Dimensional Antiferromagnets Using Graphene Heterostructures](https://arxiv.org/abs/2609.16725)
...
### [21] [The Closer, the Better: Engineering RGB Thermometric Performance in Tb3+, Eu3+-Doped MOFs](https://arxiv.org/abs/2609.16734)
...
### [22] [Electric-Field-Switchable Altermagnetism via Ligand Rotation in a d0 Metal-Organic Framework](https://arxiv.org/abs/2609.16749)
...
### [23] [Floquet Spin-Antiferroelectric Phase in Collinear Antiferromagnets](https://arxiv.org/abs/2609.16758)
...
### [24] [Interplay between Interlayer Shift and Twist: Twisted van der Waals Nanowires Driven by Rotational Twinning](https://arxiv.org/abs/2609.16771)
...
### [25] [Topological spin textures in 2D altermagnetic chromium chalcogenides: Interplay between magnetic frustration and Dzyaloshinskii-Moriya interaction](https://arxiv.org/abs/2609.16780)
...
### [26] [SpectraFit XPS: a free, browser-based application for X-ray photoelectron spectroscopy peak fitting and quantification](https://arxiv.org/abs/2609.16789)
*Yongsup Park*
...
### [27] [Fractional-Quantum Ferroelectrics: A Route to High-Mobility Ferroelectric Semiconductors](https://arxiv.org/abs/2609.16799)
...
### [30] [Development of a Physics-Informed Neural Framework, MEOWN, for Rapid Prediction of Muon Stopping Sites in Crystalline Materials, for understanding Quantum Magnet employing Muon Spectroscopy](https://arxiv.org/abs/2609.17063)
...
### [31] [Beyond the Binary Hull: Higher-Order Thermodynamic Stabilization in Inorganic Ternary Compounds](https://arxiv.org/abs/2609.17098)
*Pravan Omprakash*
...
### [32] [AI for Science with GPT-6 Astra: Thermal Design and Electrothermal Analysis of 2D CFET](https://arxiv.org/abs/2609.17123)
...
### [33] [A transfer-rod-mounted rotatable sample holder enabling a compact modular vacuum system for ion-beam milling, oblique magnetron sputtering, and co-sputtering](https://arxiv.org/abs/2609.17220)
...
### [34] [Higher order anharmonicity and polymorphism in the lattice thermal conductivity of transition metal dichalcogenides](https://arxiv.org/abs/2609.17270)
...
### [35] [High-Pressure Refractive Indices of NaCl, KCl, CaO, SrO, and MgO Reveal the Dependence of Anion Polarizability on Coordination Number and Bond Length](https://arxiv.org/abs/2609.17290)
...
### [36] [Bridging powder and multi-crystal diffraction with basis-adaptive texture tomography](https://arxiv.org/abs/2609.17299)
...
### [37] [Multiproperty Atomistic Characterization of a Synthesized Pyrazinic Nitrogen-Doped Porous Armchair Graphene Nanoribbon](https://arxiv.org/abs/2609.17305)
...
### [38] [Integrated quantum-secured cryptographic memory in customizable single nanodiamonds](https://arxiv.org/abs/2609.17329)
...
### [39] [Designing Homogeneous Ti-Nb-Fe-Sn $β$ Titanium Alloys by PBF-LB: A Pre-Alloyed Powder Blend Strategy](https://arxiv.org/abs/2609.17476)
...
### [40] [Enhanced thermal stability of SiGeSn by suppressing surface-mediated degradation](https://arxiv.org/abs/2609.17504)
...
### [41] [The chemistry of embrittlement: How hydrogen dwindles cohesion in iron during fracture](https://arxiv.org/abs/2609.17508)
*Aleksei Egorov*
...
### [42] [Anderson localization in topological metals](https://arxiv.org/abs/2609.16124)
*A. A. Burkov*
...
### [43] [An improved auxiliary boson method for quantum dots with finite Coulomb interaction U](https://arxiv.org/abs/2609.16311)
...
### [44] [Probing proximity-induced superconductivity in bilayer graphene using gate-defined quantum dots](https://arxiv.org/abs/2609.16320)
...
### [45] [Entropy-driven transitions between extended integer and fractional quantum Hall regimes](https://arxiv.org/abs/2609.16483)
...
### [46] [Accurate noise spectroscopy using quantum sensing ensembles](https://arxiv.org/abs/2609.16643)
...
### [47] [1/f frequency noise in mechanical resonators scales inversely with volume, not with quality factor](https://arxiv.org/abs/2609.16668)
*M. L. Roukes*
...
### [48] [Room-temperature 1/3 suppression of diffusive shot noise](https://arxiv.org/abs/2609.16783)
...
### [49] [Generation of pure spin currents via nonadiabatic quantum pumping in an antiferromagnetic chain](https://arxiv.org/abs/2609.16819)
...
### [50] [Propulsion of magnetic domain walls via elastic damping in magnetostrictive materials](https://arxiv.org/abs/2609.16904)
...
### [51] [Nonlinear Hall Effect in Altermagnetic Warped Topological Insulators](https://arxiv.org/abs/2609.17001)
*Debashree Chowdhury*
...
### [52] [Self-balancing luminescence kinetics of charged excitons in WS$_2$ monolayer](https://arxiv.org/abs/2609.17289)
...
### [53] [Exact solutions of nonreciprocal Su-Schrieffer-Heeger model with domain walls](https://arxiv.org/abs/2609.17378)
...
### [54] [Visualizing Berry curvature in a Floquet-Chern insulator](https://arxiv.org/abs/2609.17500)
