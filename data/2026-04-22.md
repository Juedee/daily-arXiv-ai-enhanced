...
### [1] [Localization and universality of three-dimensional pseudospin-$s$ fermions](https://arxiv.org/abs/2604.18690)
...
### [2] [$P$-wave Orbital Magnetism](https://arxiv.org/abs/2604.18695)
...
### [3] [Large Scale Optimization of Disordered Hubbard Models through Tensor and Neural Networks](https://arxiv.org/abs/2604.18711)
...
### [4] [Proximitized Topological Insulator Charge Island Fabricated via In Situ Multi-Angle Stencil Lithography](https://arxiv.org/abs/2604.18736)
...
### [5] [Landau levels and magneto-optics in 30$^\circ$ quasi-periodic twisted bilayer graphene](https://arxiv.org/abs/2604.18854)
...
### [6] [Ultrafast Light-Induced Magnetoelectric Effect in van der Waals Magnetic Semiconductor Heterostructures](https://arxiv.org/abs/2604.19080)
...
### [7] [Josephson diode effect in multichannel Rashba nanowires: role of inter-subband coupling](https://arxiv.org/abs/2604.19385)
...
### [8] [Coherent Microwave Driving of Domain Wall Depinning in a Ferrimagnetic Garnet](https://arxiv.org/abs/2604.19164)
...
### [9] [Optical conductivity of topological semimetal Nb$_{2n+1}$Si$_n$Te$_{4n+2}$](https://arxiv.org/abs/2604.19166)
*Seongjin Ahn*
...
### [10] [When heat goes astray -- non-local heating in a semiconductor](https://arxiv.org/abs/2604.19203)
...
### [11] [Emergence of rigid Polycrystals from atomistic Systems with general Interactions](https://arxiv.org/abs/2604.19239)
...
### [12] [Quantum transport in gapped graphene under strain and laser--electrostatic barriers](https://arxiv.org/abs/2604.19297)
...
### [13] [Perspective: Quantum Computing on Magnetic Racetrack](https://arxiv.org/abs/2604.19304)
...
### [14] [Intra- and Interlayer Excitonic Fine Structure of the Two-Dimensional Perovskite (PEA)$_2$PbI$_4$](https://arxiv.org/abs/2604.19327)
...
### [15] [Towards Application of Nanodiamonds for in-situ Monitoring of Radicals in Liquid Phase Chemical Reactions](https://arxiv.org/abs/2604.19433)
...
### [16] [Photonic Chirality for Braiding and Readout of Non-Abelian Anyons](https://arxiv.org/abs/2604.19456)
*Netzer Moriya*
...
### [17] [Nonequilibrium Kramers Turnover in a Kerr Parametric Oscillator](https://arxiv.org/abs/2604.19527)
...
### [18] [Landauer-based study of transport in Chern insulator heterostructures](https://arxiv.org/abs/2604.19581)
...
### [19] [Supermoiré domain-resolved effective Hamiltonians and valley topology in helical multilayer graphene](https://arxiv.org/abs/2604.19608)
...
### [20] [Competition and coexistence of superconductivity and nematic order in a two-dimensional electron gas with quadrupolar interactions](https://arxiv.org/abs/2604.18777)
...
### [21] [Stripping Symmetry: Electrochemical Oxidation to a Superconducting Polar Metal in Au2Pb0.914P2](https://arxiv.org/abs/2604.18843)
...
### [22] [AngstromPro: A versatile software for massive N-dimensional STM data management, visualization and in-depth analysis](https://arxiv.org/abs/2604.18962)
...
### [23] [Pseudogap and Condensation in Cuprate Superconductors from NMR Shifts](https://arxiv.org/abs/2604.19215)
...
### [24] [Unveiling the Superconducting Ground State of Heusler alloy Pd2ZrIn via muon spin relaxation and rotation measurement](https://arxiv.org/abs/2604.19283)
...
### [25] [Competing Constraints on Superconductivity in Thick FeSe films](https://arxiv.org/abs/2604.19443)
...
### [26] [Spatially-resolved voltage-reversal due to Bernoulli potentials in dissipative Bi$_2$Sr$_2$CaCu$_2$O$_{8+x}$](https://arxiv.org/abs/2604.19467)
...
### [27] [Observation of field-odd and field-free superconducting diode effects in $\mathrm{Mo}_2\mathrm{C}$ nanoflakes](https://arxiv.org/abs/2604.19525)
...
### [28] [General Conditions for Axis Dependent Conduction Polarity](https://arxiv.org/abs/2604.18687)
...
### [29] [Proximity Magnetism in Mn(Bi,Sb)2Te4-(Bi,Sb)2Te3/MnTe Natural Heterostructures](https://arxiv.org/abs/2604.18935)
...
### [30] [Magnetic Polarons Enable Exceptional Magnetocaloric Response](https://arxiv.org/abs/2604.18938)
...
### [31] [Discovery of Graphene Sheets and C-Rich Micro-Oval structure in Stingless Bee Hive; Leading to an Emergent Material with Debut of Blue Emission](https://arxiv.org/abs/2604.19096)
...
### [32] [Controlling Quantum Materials by Growth: Thermodynamics, Kinetics, and Defect Engineering in Transition Metal Dichalcogenides](https://arxiv.org/abs/2604.19110)
...
### [33] [Electronic-Entropy-Driven Crossover to Close-Packed Phases in Transition Metals under Strong Electronic Excitation](https://arxiv.org/abs/2604.19222)
...
### [34] [Rippled graphene pores as fluidic memristive devices with synaptic and neuromorphic functionalities](https://arxiv.org/abs/2604.19228)
...
### [35] [Electrically steered conduction topologies and period-doubling phase dynamics in VO2](https://arxiv.org/abs/2604.19329)
...
### [36] [True random number generation through stochastic magnonic bistability](https://arxiv.org/abs/2604.19356)
...
### [37] [Multimodal Transformer for Sample-Aware Prediction of Metal-Organic Framework Properties](https://arxiv.org/abs/2604.19383)
...
### [38] [Operando Characterization of Volume Changes in Lithium-Ion Battery Electrodes during Cycling using Isotope Multilayers](https://arxiv.org/abs/2604.19519)
...
### [39] [Lattice thermal transport from phonon spectra beyond perturbation theory](https://arxiv.org/abs/2604.19615)
...
### [40] [Electronic structure and oxidation states in high-pressure synthesized isostructural CeCN$_5$ and TbCN$_5$](https://arxiv.org/abs/2604.19629)
...
### [41] [Atomic-scale origin of charge density wave-driven metal-semiconductor transition in an incommensurately modulated metal-organic framework](https://arxiv.org/abs/2604.19640)
...
### [42] [Intrinsic i-wave altermagnetism in 2D graphene superlattices](https://arxiv.org/abs/2604.19661)
