...
### [1] [Transport in close-packed solids with stacking defects](https://arxiv.org/abs/2602.18574)
...
### [2] [Nonabelian Anyons attached to Superconducting Islands in FQH Liquids](https://arxiv.org/abs/2602.18748)
...
### [3] [Prediction of the atomistic Hubbard U interaction from moiré system STM-images using image recognition](https://arxiv.org/abs/2602.18890)
...
### [4] [Atomistic substrate relaxation effects in the band gaps of graphene on hexagonal boron nitride](https://arxiv.org/abs/2602.18893)
...
### [5] [Exact expression for the Berry connection in the projection gauge](https://arxiv.org/abs/2602.18973)
...
### [6] [Nonlinear spin-Seebeck diode in $f$-wave magnets, third-order spin-Nernst effects in $g$-wave magnets and spin-Nernst effects in $i$-wave altermagnets](https://arxiv.org/abs/2602.19034)
*Motohiko Ezawa*
...
### [7] [Bridging Quantum and Classical Descriptions of Spin Dynamics in a Dzyaloshinsky-Moriya Trimer](https://arxiv.org/abs/2602.19060)
...
### [8] [Dynamics and Pinning for Skyrmions in Altermagnets](https://arxiv.org/abs/2602.19258)
...
### [9] [Pattern of indirect excitons in van der Waals heterostructure](https://arxiv.org/abs/2602.19438)
...
### [10] [Temporal magnon-qubit Mach-Zehnder interferometer](https://arxiv.org/abs/2602.19492)
...
### [11] [Rashba Spin-Orbit Coupling Induced Topological Phases Transition in Honeycomb Nanoribbon Heterojunction](https://arxiv.org/abs/2602.19568)
...
### [12] [Optical properties of single CsPbBr3 perovskite quantum dots synthesized by a modified ligand-assisted reprecipitation method](https://arxiv.org/abs/2602.19693)
...
### [13] [Quantum Resource Theory of Lasers](https://arxiv.org/abs/2602.19749)
...
### [14] [Transcendental momentum quantization in semiconducting Rashba nanowires and zero energy states in their normal and superconducting phase](https://arxiv.org/abs/2602.19796)
...
### [15] [Kerr-like effect induced by quantum-metric nematicity](https://arxiv.org/abs/2602.19894)
...
### [16] [The interplay of cation/anion and monovalent/divalent selectivity in negatively charged nanopores: local charge inversion and anion leakage](https://arxiv.org/abs/2602.19992)
...
### [17] [AI/ML-Driven Surface Plasmon Resonance (SPR) and Spectroscopy: Materials Interfaces and Autonomous Experiments](https://arxiv.org/abs/2602.18538)
...
### [18] [Buried Stressor Engineering for Position-Controlled InGaAs Quantum Dots with Local Density Variation for Integrated Quantum Photonics](https://arxiv.org/abs/2602.18543)
...
### [19] [Tuning of Atomic Layer Deposition Pulse Time through Physics-Informed Bayesian Active Learning](https://arxiv.org/abs/2602.18565)
...
### [20] [When Atoms Choose Their Neighbors: Element-Specific Views of Local Chemical Order in High-Entropy Alloys](https://arxiv.org/abs/2602.18599)
...
### [21] [Real-time vacancy concentration evolution revealed via heavy ion irradiation experiments](https://arxiv.org/abs/2602.18608)
...
### [22] [A ReaxFF-based thermomechanical analysis of N-carbophenes: phase-change, thermal expansion, and high temperature synthesis pathway](https://arxiv.org/abs/2602.18712)
...
### [23] [EXAFS studies of the local environment of lead and selenium atoms in PbTe$_{1-x}$Se$_x$ solid solution](https://arxiv.org/abs/2602.18789)
...
### [24] [Beam-Offset Thermoreflectance with Bayesian Optimization to Measure the Anisotropic Thermal Properties of Semiconductor Superlattices](https://arxiv.org/abs/2602.18840)
...
### [25] [Layer-number parity induced topological phase transition](https://arxiv.org/abs/2602.18855)
...
### [26] [Work-hardening exhaustion as the origin of low toughness in L-PBF alloys: A case study on the role of intrinsic vs. extrinsic defects in SS316L](https://arxiv.org/abs/2602.18954)
...
### [27] [A computationally efficient approach for predicting the transport properties of transition-metal alloys at elevated temperatures](https://arxiv.org/abs/2602.18979)
...
### [28] [Hidden Chiral Ferroelectricity in AgNbO$_3$ Perovskite](https://arxiv.org/abs/2602.19036)
...
### [29] [Giant Out-of-Plane Magnetic Orbital Torque of Altermagnets from Spin-Group Symmetry Breaking](https://arxiv.org/abs/2602.19076)
...
### [30] [Constrained Diffusion for Accelerated Structure Relaxation of Inorganic Solids with Point Defects](https://arxiv.org/abs/2602.19153)
...
### [31] [Specific features of the magnetic-field dependences of electrical resistivity in Bi--Mn solid solutions with low Mn content](https://arxiv.org/abs/2602.19181)
...
### [32] [Unraveling the temperature-responsive charge-disproportionation in BaBiO$_3$](https://arxiv.org/abs/2602.19283)
...
### [33] [Dual energy-differentiated topological transition in artificial red phosphorus chains](https://arxiv.org/abs/2602.19347)
...
### [35] [Improving Reliability of Machine Learned Interatomic Potentials With Physics-Informed Pretraining](https://arxiv.org/abs/2602.19592)
...
### [36] [Rotational anisotropy Raman spectrometer for high-sensitivity crystallographic symmetry analysis](https://arxiv.org/abs/2602.19617)
...
### [37] [Coherent Phonon-Driven Band Renormalizations in 1T$'$-MoTe$_2$](https://arxiv.org/abs/2602.19630)
...
### [38] [Theory of strained quantum emitters](https://arxiv.org/abs/2602.19640)
...
### [39] [Investigation of Corroded T91 Steel in Static Lead-Bismuth Eutectic Under an Oxidising Environment](https://arxiv.org/abs/2602.19642)
...
### [40] [Strain- and Field-Tunable Nonrelativistic Spin Splitting and Wave-Symmetry-Dependent Spin Transport in Twisted Bilayer Altermagnets](https://arxiv.org/abs/2602.19713)
...
### [41] [Bismuth-substituted Lutetium Iron Garnet Films with Giant Visible-Range Magneto-Optical Sensitivity](https://arxiv.org/abs/2602.19793)
...
### [42] [Interface stability of beta-Ga2O3 (100) on oxidized Si- and C-terminated 3C-SiC (001) substrates: a first-principles investigation](https://arxiv.org/abs/2602.19820)
...
### [43] [Automated structure discovery for Tip Enhanced Raman Spectroscopy](https://arxiv.org/abs/2602.19932)
...
### [44] [Electronic structure of Graphene/Co interfaces](https://arxiv.org/abs/2602.19955)
...
### [45] [Cr3+ spin dynamics under the octahedral crystal field in van der Waals antiferromagnets](https://arxiv.org/abs/2602.20033)
...
### [46] [The effect of the A-site cation on the phase transition temperature of metal halide perovskites](https://arxiv.org/abs/2602.20058)
...
### [47] [Tunable dislocations overcome mechano-functional tradeoff in perovskite oxides](https://arxiv.org/abs/2602.20121)
...
### [48] [Microstructural Evolution and Crystallization Behavior of Amorphous Medium-Entropy Ti-Nb-Zr-Ag Thin Films](https://arxiv.org/abs/2602.20129)
...
### [49] [Role of octahedral tilting induced acoustic softening on limiting thermal transport in SrSnO3](https://arxiv.org/abs/2602.20142)
...
### [50] [Superconducting phase diagram of multi-layer square-planar nickelates](https://arxiv.org/abs/2602.19093)
...
### [51] [Nearly twofold overestimation of the superconducting volume fraction in pressurized Ruddlesden-Popper nickelates](https://arxiv.org/abs/2602.19282)
...
### [52] [Enhanced $T_\mathrm{c}$ in eutectic high-entropy alloy superconductors Hf-Nb-Sc-Ti-Zr](https://arxiv.org/abs/2602.19371)
...
### [53] [Insight into high-entropy effect in body-centered cubic superconducting alloys](https://arxiv.org/abs/2602.19376)
...
### [54] [Imaging the Superconducting Proximity Effect in S-S'-S Transition Edge Sensors](https://arxiv.org/abs/2602.19399)
...
### [55] [Bridging atomic and mesoscopic length scales with Replica Scanning Tunneling Microscopy: Visualizing the intra-unit cell pair density modulation of superconducting FeSe at micron length scale](https://arxiv.org/abs/2602.19678)
...
### [56] [Anisotropic fully-gapped superconductivity in quasi-one-dimensional Li$_{0.9}$Mo$_6$O$_{17}$](https://arxiv.org/abs/2602.19724)
...
### [57] [Machine learning protocol to identify pairing symmetries via quasiparticle interference imaging in Ising superconductors](https://arxiv.org/abs/2602.19791)
...
### [58] [Periodic drive induced unconventional superconductivity in a half-filled system](https://arxiv.org/abs/2602.19920)
...
### [59] [Vortex Tunneling and Critical State in an Oxide Heterostructure](https://arxiv.org/abs/2602.20148)
