...
### [2] [Singular high-harmonic transport above a quantum threshold](https://arxiv.org/abs/2609.20990)
...
### [3] [Bend Contour Electron Tomography (BCET): Quantitative strain and topography mapping](https://arxiv.org/abs/2609.21041)
...
### [14] [Deformation-induced amorphous complexion transitions elevate strength and ductility](https://arxiv.org/abs/2609.20908)
...
### [15] [Faulted loop nucleation and dopant activation in Al-implanted 4H-SiC](https://arxiv.org/abs/2609.20986)
...
### [16] [Dual-Sublattice Ferromagnetism Driven by Cooperative Double Exchange and Superexchange at NdNiO$_3$/CaMnO$_3$ Interfaces](https://arxiv.org/abs/2609.21002)
...
### [17] [Mechanism of charge transfer and electrostatic field fluctuations in complex metallic alloys](https://arxiv.org/abs/2609.21065)
...
### [18] [Polymer-free Assembly of Unencapsulated van der Waals Heterostructure Devices](https://arxiv.org/abs/2609.21120)
...
### [19] [Adaptive Mesh Coarsening for Efficient Phase-Field Fracture Simulations](https://arxiv.org/abs/2609.21201)
...
### [20] [The Critical Role of Itinerant Contributions to Orbital Angular Momentum Relaxation and Dynamics](https://arxiv.org/abs/2609.21300)
...
### [21] [Strain-Induced Relaxor Multiferroicity at Room Temperature in Hexaferrite BaFe12O19 Thin Films](https://arxiv.org/abs/2609.21352)
...
### [22] [Single Best Fits Can Be Misleading: Resolving Common Trapping Signatures across FA--Cs Perovskites](https://arxiv.org/abs/2609.21545)
...
### [23] [Orbital angular momentum accumulation in SrVO3 thin films](https://arxiv.org/abs/2609.21551)
...
### [24] [Validation of an Ab Initio-Informed Electronic Stopping Model for Large-Scale Atomistic Simulations](https://arxiv.org/abs/2609.21559)
...
### [25] [Material chemical compositon impacts on the band alignments: Preliminary results on the 3D/2D perovskite interfaces](https://arxiv.org/abs/2609.21654)
*Philippe Baranek*
...
### [26] [Adsorption of Phosgene Gas on Pristine and Noble Metal-Doped B12N12 Nanocages: Insights from Density Functional Theory](https://arxiv.org/abs/2609.21678)
...
### [27] [Complete Neural Electronic Initialization Accelerates Materials DFT](https://arxiv.org/abs/2609.21759)
...
### [28] [Electrodeposited Co and Ni Hexacyanoferrates: Insights into Structure and Morphology](https://arxiv.org/abs/2609.21819)
...
### [29] [Multivalley 3D Electronic Structure of PbSe from Soft-X-Ray ARPES and First-Principles Calculations](https://arxiv.org/abs/2609.21824)
...
### [30] [PhonoMC: Occupation-based deviational Monte Carlo for phonon transport with temperature-dependent scattering](https://arxiv.org/abs/2609.21884)
...
### [31] [Low resistance NiO/β-Ga_{2}O_{3} heterojunction diodes grown via molecular beam epitaxy](https://arxiv.org/abs/2609.21901)
...
### [32] [PAOFLOW: an automated suite for ab initio electronic, transport, and topological properties of materials](https://arxiv.org/abs/2609.21984)
...
### [33] [Insights into the long-standing controversy over sound velocities in lizardite](https://arxiv.org/abs/2609.22009)
...
### [34] [Symmetry Classification of Multipolar Orders in Crystals: Theory, Property Tensors and Automated Analysis with MagSymMultipoles](https://arxiv.org/abs/2609.22030)
...
### [35] [Metallic Néel order stabilized by coupling between inequivalent Hubbard layers](https://arxiv.org/abs/2609.20922)
...
### [36] [Smectic Superconductivity](https://arxiv.org/abs/2609.20932)
...
### [37] [Digital-analog concept for superconducting perceptron-like neural networks](https://arxiv.org/abs/2609.21613)
...
### [38] [Collective excitation-mediated transport in nanoscale Josephson junctions that exhibit quantum confinement](https://arxiv.org/abs/2609.21725)
...
### [39] [Universal Dzyaloshinski-Moriya interaction dictates pairing in unconventional superconductor families](https://arxiv.org/abs/2609.21731)
...
### [40] [Topological properties and gap structure of the paired state in twisted TMD bilayers within a two-band effective model](https://arxiv.org/abs/2609.21825)
...
### [41] [Failure of Conventional Roughness Metrics in Assessing Field-Limiting Mesoscopic Topography in SRF Nb Films on Cu](https://arxiv.org/abs/2609.21835)
...
### [42] [Strong-coupling multigap superconductivity in the Heusler compound ScAu$_2$Al](https://arxiv.org/abs/2609.21845)
...
### [43] [Tunneling Spectroscopy Study of Low Baked Bulk Niobium for Superconducting RF Cavity Applications](https://arxiv.org/abs/2609.21865)
