...
### [2] [Symmetry-selective nonrelativistic spin splitting in antiferromagnets driven by coherent phonons](https://arxiv.org/abs/2609.01844)
...
### [3] [Molecular spin qubits in a van der Waals bottle](https://arxiv.org/abs/2609.01872)
...
### [4] [Morphology and Dynamics of Self-interstitial Clusters in Irradiated Nickel](https://arxiv.org/abs/2609.01879)
...
### [5] [Machine Learning Local Potentials for Accelerated Electron-Phonon Interactions Calculations within the Projector Augmented-Wave Framework](https://arxiv.org/abs/2609.01923)
*Yi Xia*
...
### [6] [Machine-learning screening and first-principles lattice dynamics resolve the most stable structure of NaCa(BH$_4$)$_3$ from a data-driven candidate search](https://arxiv.org/abs/2609.02001)
...
### [7] [Symmetry-enforced third-order nonlinear thermal Hall effects in altermagnets](https://arxiv.org/abs/2609.02008)
...
### [8] [EuIn2Sb2: epitaxially stabilized axion insulator candidate with strong spin-orbit coupling](https://arxiv.org/abs/2609.02114)
...
### [9] [Charge-Transfer Electronic Structure of NiX$_2$ (X = S, Se)](https://arxiv.org/abs/2609.02148)
...
### [10] [The Locality Cost of Fully Flat Hopf Insulators](https://arxiv.org/abs/2609.02199)
...
### [11] [Decoding Oxygen K-edge Fingerprints of NCM-811 Degradation via Ab Initio Many-Body Theory and High-Throughput Screening of Crystal Proxies](https://arxiv.org/abs/2609.02206)
...
### [12] [Linker Functionalization and pH Tuning Enhance Solar-Driven Catalytic CO$_2$ Reduction in MOF-5](https://arxiv.org/abs/2609.02256)
...
### [13] [Vitrification-Devitrification Enables Tunable Photonic and Gas Sorption Properties of Zeolitic Imidazolate Frameworks](https://arxiv.org/abs/2609.02287)
...
### [14] [Ferroelastic domain switching by ultrafast photoinduced strain](https://arxiv.org/abs/2609.02321)
...
### [15] [Magneto-Structural Coupling Enables Cryogenic Cation Redistribution in a Spinel Oxide](https://arxiv.org/abs/2609.02368)
...
### [16] [Molecular-dynamics-based modal analysis of heat transport in quasi-one-dimensional systems from a symmetry-adapted perspective](https://arxiv.org/abs/2609.02397)
...
### [17] [Chemical pressure and vacancies in crystals under nonhydrostatic stress](https://arxiv.org/abs/2609.02435)
*Michiel Sprik*
...
### [18] ['pySNOW': a Python Suite for the NanO-World](https://arxiv.org/abs/2609.02492)
...
### [20] [Spin Hall Magnetoresistance in Antiferromagnetic Insulators](https://arxiv.org/abs/2609.02632)
...
### [21] [From Goldene to Noblene: exhaustive enumeration of the ordered Au-Ag-Cu monolayer alloys](https://arxiv.org/abs/2609.02709)
...
### [22] [A Wannier-first approach for extended chiral systems](https://arxiv.org/abs/2609.02524)
...
### [23] [All-dry processing of 3C-SiC nanomechanical string resonators for extreme aspect ratios and high intrinsic quality factor](https://arxiv.org/abs/2609.02530)
...
### [24] [Colossal reversible conductivity switching by room-temperature oxygen-vacancy ordering in Aurivillius oxide films](https://arxiv.org/abs/2609.02629)
...
### [30] [Tuning Boron-Vacancy Qubit Coherence through Layer Number in hBN](https://arxiv.org/abs/2609.01812)
...
### [31] [Magnons in Metallic Altermagnetic $\text{KV}_2\text{Se}_2\text{O}$](https://arxiv.org/abs/2609.01853)
...
### [32] [Complete Topological Classification with P and T Symmetries: Revealing a Topological Invariant Invisible to K-Theory](https://arxiv.org/abs/2609.02025)
*Chen Zhang,Y. X. Zhao*
...
### [33] [Persistence and emergence of quantum defects through pressure-induced phase changes](https://arxiv.org/abs/2609.02100)
...
### [34] [In silico design of magnonic lasing in constricted waveguides](https://arxiv.org/abs/2609.02338)
...
### [35] [Room-temperature local strain control of moiré excitons in MoS$_2$/WSe$_2$ heterobilayers](https://arxiv.org/abs/2609.02340)
...
### [36] [Direct observation of flat bands in near-magic-angle twisted bilayer CVD graphene](https://arxiv.org/abs/2609.02403)
...
### [37] [Rank-Selective Optical Tomography of Higher-Wave Altermagnetism](https://arxiv.org/abs/2609.02429)
...
### [38] [Direct Observation of the Zigzag Edge States of a Supramolecular Diatomic Kagome Lattice](https://arxiv.org/abs/2609.02567)
...
### [39] [Nonreciprocal Magnon Hanle Effect in Antiferromagnetic $α$-Fe$_2$O$_3$](https://arxiv.org/abs/2609.02631)
...
### [40] [Twist as a Mechanical Switch for Reconfigurable Stacking in h-BN](https://arxiv.org/abs/2609.02723)
...
### [41] [QArray+: A physics-informed GPU-accelerated simulator for quantum dot arrays](https://arxiv.org/abs/2609.02736)
...
### [42] [Emergence of the magnetic octupole Rashba-Edelstein effect from spin-orbit entanglement](https://arxiv.org/abs/2609.02768)
...
### [43] [Relaxation effects on Hartree-Fock ground states in twisted bilayer graphene at even integer fillings](https://arxiv.org/abs/2609.02815)
...
### [44] [Interaction effects on Andreev states from an electromagnetic environment](https://arxiv.org/abs/2609.01935)
...
### [45] [Vortex-core Majorana coupling to a chiral edge in a $p_x+ip_y$ superconductor: Nonmonotonic spectral reorganization and coherent fermion-parity dynamics](https://arxiv.org/abs/2609.02260)
*Peiyao Liu,Yi Zhou*
...
### [46] [Anomalous Superfluid Response in Altermagnetic Superconductors](https://arxiv.org/abs/2609.02263)
...
### [47] [Quantum Structural Renormalization and Anharmonic Stabilization of Superconductivity in P4/mmm YScH8](https://arxiv.org/abs/2609.02295)
...
### [48] [Electronic Structure and Superconductivity in La$_{1.55}$Sr$_{0.45}$CuO$_4$/La$_2$CuO$_4$ Artificial High-$T_c$ Superlattices Probed by Hard and Soft X-ray Spectroscopy](https://arxiv.org/abs/2609.02668)
