...
### [3] [Using a spin-triplet encoding to enhance shuttling fidelities in Si/SiGe quantum wells](https://arxiv.org/abs/2605.12687)
...
### [4] [Negative Differential Resistance and Ultra-High TMR in Altermagnetic Tunnel Junctions](https://arxiv.org/abs/2605.12711)
...
### [5] [Terahertz detection within charge density wave state](https://arxiv.org/abs/2605.12949)
*Zhi Li*
...
### [6] [Quantized Transport in Floquet Topological Insulators](https://arxiv.org/abs/2605.13066)
...
### [7] [Observation of end-to-end pumping in a quasiperiodic Fibonacci-type photonic chain](https://arxiv.org/abs/2605.13116)
...
### [8] [Electron - acoustic phonons scattering in quantum wells in a tilted quantizing magnetic field](https://arxiv.org/abs/2605.13274)
...
### [9] [Reconfigurable chiral superconductivity](https://arxiv.org/abs/2605.13303)
...
### [10] [Thermoelectric enhancement from an asymmetric spectral-conductivity cusp in spin-1 chiral fermions](https://arxiv.org/abs/2605.13323)
...
### [11] [Lamb Shift of Landau Levels in Two-Dimensional Electron Systems in a Multimode Resonator](https://arxiv.org/abs/2605.13351)
...
### [12] [An Effective Scaling Framework for Non-Adiabatic Mode Dynamics](https://arxiv.org/abs/2605.13376)
*A. M. Tishin*
...
### [13] [Probing Floquet topological phases via non-Hermitian skin effect of reflected waves](https://arxiv.org/abs/2605.13563)
...
### [14] [Cryogenic microwave frequency combs based on quantum paraelectric superconducting resonators](https://arxiv.org/abs/2605.13571)
...
### [15] [Enhanced Near-Field Thermal Radiation Driven by Multiple Corner and Edge Modes in Subwavelength Square Nanowires](https://arxiv.org/abs/2605.13712)
...
### [16] [Shubnikov-de Haas Characterization of Superconductor-Semiconductor Heterostructures](https://arxiv.org/abs/2605.13722)
...
### [17] [Magnetization-dependent and stacking-tunable Edelstein effect in two-dimensional magnet 2H-VTe2](https://arxiv.org/abs/2605.13763)
...
### [18] [Direct-write electrochemical nanofabrication of ultrasmall graphene devices](https://arxiv.org/abs/2605.12660)
...
### [19] [Bridging perturbation and variational approaches in brittle fracture](https://arxiv.org/abs/2605.12631)
...
### [20] [Ultrafast electron dynamics of electron-irradiated graphene](https://arxiv.org/abs/2605.12854)
...
### [21] [Selective Octahedral Accommodation of Cr$^{3+}$ and Weak Magnetic Connectivity in the Sugilite Analogue KNa$_2$Cr$_2$Li$_3$Si$_{12}$O$_{30}$](https://arxiv.org/abs/2605.12986)
...
### [22] [Apparent Ferroelectric Polarization Hysteresis and a Simple Method to Observe Piezoelectric Strain Loops with a Microphone](https://arxiv.org/abs/2605.13089)
*Mamoru Fukunaga*
...
### [23] [Ultrafast Critical Slowing of Spin Dynamics and Emergent Nonequilibrium Fano Interference in Fe3GeTe2](https://arxiv.org/abs/2605.13121)
...
### [24] [Helium Bubbles in Liquid Lead Lithium Solutions: Pressure Inhomogeneities at Interfaces and Non Ideal Mixture Effects](https://arxiv.org/abs/2605.13164)
...
### [25] [Structural, electronic, and optical properties of hexagonal GeSn from density functional theory](https://arxiv.org/abs/2605.13166)
...
### [26] [Magnesium-graphene interphase boundaries created by high-pressure torsion enhance hydrogen storage kinetics:Mechanisms and significance of activation energy and frequency factor](https://arxiv.org/abs/2605.13184)
...
### [27] [Conditional probability density functional theory for solids](https://arxiv.org/abs/2605.13226)
...
### [28] [Defect annihilation mechanism in the formation of dodecagonal quasicrystals](https://arxiv.org/abs/2605.13253)
...
### [29] [From Film to Flakes: Electronic Properties and Magnetization Variations in Yttrium Iron Garnet](https://arxiv.org/abs/2605.13441)
...
### [30] [Multiple Softening Q-vectors Driving a Cascade of CDW Phases in $\mathrm{1T-VSe}_{2}$](https://arxiv.org/abs/2605.13458)
...
### [31] [High-temperature behavior of amorphous alumina coatings: Insights from in-situ nanoindentation and X-ray diffraction studies](https://arxiv.org/abs/2605.13528)
...
### [32] [Correlation-driven tunability of altermagnetism in RuO$_2$](https://arxiv.org/abs/2605.13559)
...
### [33] [Anisotropic Dopant and Strain Architectures in WS$_2$ Nanocrystals Driven by Growth Kinetics](https://arxiv.org/abs/2605.13577)
...
### [34] [Magnetocaloric Effect in Nanostructured $La_{0.6}Sr_{0.4}Fe_{1-x}Co_{x}O_3$](https://arxiv.org/abs/2605.13611)
...
### [35] [OpenAaaS: An Open Agent-as-a-Service Framework for Distributed Materials-Informatics Research](https://arxiv.org/abs/2605.13618)
...
### [36] [Layer thickness dependent band gap of MBE grown single- to few-layer MoS$_{2}$](https://arxiv.org/abs/2605.13637)
...
### [37] [High-Pressure XRD Study of Ti-3Al-2.5V Titanium Alloy: Intermediate Transition Pressure and Composition Trends in Ti-Al-V Alloys](https://arxiv.org/abs/2605.13658)
...
### [38] [Nonlinear dynamic elastic moduli from equilibrium stress fluctuations](https://arxiv.org/abs/2605.13703)
...
### [39] [Giant optical spin-orbit interactions in ferroelectric van der Waals waveguides](https://arxiv.org/abs/2605.13707)
...
### [40] [Chiral molecule-induced contributions to ferromagnetic resonance](https://arxiv.org/abs/2605.13805)
...
### [41] [Multiband Superconductivity in the Exactly Solvable Hatsugai-Kohmoto Model](https://arxiv.org/abs/2605.13259)
...
### [42] [Interface controlled spin filtering and nonreciprocal transport in Altermagnet/Ising superconductor junctions](https://arxiv.org/abs/2605.13317)
